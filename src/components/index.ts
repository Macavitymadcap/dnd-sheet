...
export function registerComponents() {
  if (!customElements.get("sheet-nav")) {
    customElements.define("sheet-nav", SheetNav);
  }
  if (!customElements.get("sheet-toolbar")) {
    customElements.define("sheet-toolbar", SheetToolbar);
  }
